      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
          ...
          <div className="space-y-6">
            {/* Logo container avec effets améliorés */}
            ...
            <p className="text-white/90 leading-relaxed backdrop-blur-sm">
              Analytechs vous accompagne dans votre transformation digitale avec des solutions innovantes en Business Intelligence, Data Analytics et Conseil en Management.
            </p>
          ...
          <div className="backdrop-blur-sm">
            <h3 className="text-lg font-semibold mb-6 text-white">Liens Utiles</h3>
          ...
          <div className="backdrop-blur-sm">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:+33123456789" className="flex items-center text-white/90 hover:text-secondary transition-colors group">
