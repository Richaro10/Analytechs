...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ["Analyse prédictive", "Machine Learning", "Big Data", "Data Mining"],
      benefits: ["Prédictions précises", "Automatisation intelligente", "Insights avancés", "Avantage concurrentiel"]
    },
    {
      ...
      features: ["Applications web", "Applications mobiles", "APIs", "Intégrations"],
      benefits: ["Solutions personnalisées", "Performance optimale", "Scalabilité garantie", "Maintenance simplifiée"]
    },
    {
      ...
      features: ["Stratégie digitale", "Optimisation des processus", "Gestion du changement", "Formation"],
      benefits: ["Vision claire", "Efficacité accrue", "Équipes alignées", "Objectifs atteints"]
    },
    {
      icon: <LineChart className="h-12 w-12 text-accent" />,
      title: "Contrôle de Gestion",
      description: "Pilotez votre performance financière et opérationnelle.",
      features: ["Tableaux de bord financiers", "Analyse des coûts", "Budgétisation", "Prévisions"],
      benefits: ["Meilleure rentabilité", "Coûts maîtrisés", "Décisions éclairées", "Croissance durable"]
    },
    {
      icon: <Users className="h-12 w-12 text-accent" />,
      title: "Webmarketing",
      description: "Développez votre présence en ligne et attirez plus de clients.",
      features: ["SEO", "Marketing digital", "Analyse de données", "Stratégie de contenu"],
      benefits: ["Visibilité accrue", "Trafic qualifié", "Conversion optimisée", "ROI maximisé"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Seo
        title={`Nos Services - ${defaultMeta.siteName}`}
        description="Découvrez les services de Business Intelligence, Data Analytics, développement d'applications, conseil et webmarketing proposés par Analytechs Burkina Faso."
          ...
          {services.map((service, index) => (
            <div key={index} className="group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
              ...
              <div className="relative p-8">
                ...
                <Link to="/contact" className="inline-flex items-center text-accent hover:text-primary transition-colors group-hover:translate-x-2 transform transition-transform">
                  En savoir plus
