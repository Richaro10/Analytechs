...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Seo
        title={`Politique de Confidentialité - ${defaultMeta.siteName}`}
        description="Politique de confidentialité d'Analytechs Burkina Faso : protection, collecte et usage de vos données personnelles."
